          ...
          <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 sm-mb-30">
            <div className="footer__area-widget">
              <div className="footer__area-widget-about">
                ...
                {/* Company description */}
                <p> 
                Territorial está comprometida con la excelencia en cada uno de sus proyectos y servicios de corretaje, 
                asegurando que cada desarrollo cumpla con los más altos estándares de calidad y contribuya positivamente 
                al crecimiento y bienestar de la comunidad.
                </p>
          ...
          <div className="row align-items-center">
            <div className="col-xl-6 col-lg-6 col-md-7 md-mb-10">
              <div className="copyright__area-left md-t-center">
                  <p>© Corporación Gemma - Todos los derechos reservados</p>
              </div>
            </div>
